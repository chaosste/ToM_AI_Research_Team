...
def run_auxhead_seed(
    ...
    if seed not in AVAILABLE_SEEDS:
        raise ValueError(f"Only packaged auxhead-lite seeds {AVAILABLE_SEEDS} are available in this runner.")
    ...
    additional_episodes = target_total_episodes - start_episodes
    initial_checkpoint_sha1 = _sha1_file(checkpoint_path)
    ...
    resume_checkpoint_sha1 = _sha1_file(resume_checkpoint)
    ...
    if remaining_episodes <= 0:
        payload = {
            ...
            "initial_checkpoint_sha1": initial_checkpoint_sha1,
            ...
            "resume_checkpoint_sha1": resume_checkpoint_sha1,
...
def main(
    ...
    for seed in AVAILABLE_SEEDS:
        result = run_auxhead_seed.remote(
            seed,
            target_total_episodes=target_total_episodes,
            save_every=save_every,
            commit_interval_seconds=commit_interval_seconds,
